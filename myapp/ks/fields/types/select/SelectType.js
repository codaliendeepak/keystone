...
select.prototype.validateInput = function (data, callback) {
	console.log('------------------------------ VALIDATING SELECT-------------------------------------------- 1');
	...
	console.log('------------------------------ VALIDATING SELECT-------------------------------------------- 2');
	console.log(value, data, value === undefined || value === null || value === '' || (value in this.map) ? true : false, this.path);
	console.log('------------------------------ VALIDATING SELECT-------------------------------------------- 3');
