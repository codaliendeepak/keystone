...
var CreateForm = _react2.default.createClass({
	...
	propTypes: {
		...
		def: _react2.default.PropTypes.object,
	...
	getInitialState: function getInitialState() {
		...
		var values = {};
		console.log('Create Form  ddd:', this.props);
		Object.keys(this.props.list.fields).forEach(function (key) {
			...
			// add in urlprepopulated
			if (_this.props.def && _this.props.def[field.path]) {
				console.log('Adding default val:-----------------------------------------------------');
				values[field.path] = _this.props.def[field.path];
			}
		});
		return {
			values: values,
...
module.exports = {
	...
	renderItem: function renderItem(item, index) {
		...
		var ops = [].concat(_toConsumableArray(this.props.ops || []));
		if (!ops.find(function (el) {
			return el.value === value;
		})) ops.push({ label: value, value: value });
		console.log('>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<< ARRAY VAL', value, ops);
		return React.createElement(
			FormField,
			{ key: item.key },
			React.createElement(Input, { options: ops, ref: 'item_' + (index + 1), name: this.getInputName(this.props.path), value: value, onChange: this.updateItem.bind(this, item), onKeyDown: this.addItemOnEnter, autoComplete: 'off' }),
			React.createElement(
				Button,
...
},{"elemental":undefined,"lodash":undefined,"react":undefined,"react-dom":undefined}],95:[function(require,module,exports){
'use strict';
...
},{"../../admin/client/App/elemental":64,"../components/CollapsedFieldLabel":87,"../utils/evalDependsOn.js":129,"blacklist":undefined,"classnames":undefined,"react":undefined,"react-dom":undefined}],96:[function(require,module,exports){
'use strict';
...
},{"../../components/Checkbox":86,"../../components/ItemsTableCell":89,"../../components/ItemsTableValue":90,"react":undefined}],97:[function(require,module,exports){
'use strict';
...
},{"../../../admin/client/App/elemental":64,"../../components/Checkbox":86,"../Field":95,"react":undefined}],98:[function(require,module,exports){
'use strict';
...
},{"../../../admin/client/App/elemental":64,"react":undefined}],99:[function(require,module,exports){
'use strict';
...
},{"../../components/ItemsTableCell":89,"../../components/ItemsTableValue":90,"moment":undefined,"react":undefined}],100:[function(require,module,exports){
'use strict';
...
},{"../../../admin/client/App/elemental":64,"moment":undefined,"react":undefined,"react-day-picker":undefined,"react-dom":undefined}],101:[function(require,module,exports){
'use strict';

module.exports = require('../date/DateColumn');

},{"../date/DateColumn":99}],102:[function(require,module,exports){
'use strict';
...
},{"../../../admin/client/App/elemental":64,"../../components/DateInput":88,"../Field":95,"moment":undefined,"react":undefined}],103:[function(require,module,exports){
'use strict';

module.exports = require('../date/DateFilter');

},{"../date/DateFilter":100}],104:[function(require,module,exports){
'use strict';
...
},{"../../../admin/client/utils/string":85,"../../components/ItemsTableCell":89,"../../components/ItemsTableValue":90,"react":undefined}],105:[function(require,module,exports){
'use strict';
...
module.exports = _Field2.default.create({
	...
	renderFieldsForItem: function renderFieldsForItem(index, value) {
		...
		return Object.keys(this.props.fields).map(function (path) {
			var field = _this.props.fields[path];
			if (typeof _FieldTypes.Fields[field.type] !== 'function') {
			...
			props.mode = 'edit';
			props.inputNamePrefix = _this.props.path + '[' + index + ']';
			props.key = field.path;
			// TODO ?
			// if (props.dependsOn) {
...
},{"../../../admin/client/App/elemental":64,"../../../admin/client/App/shared/InvalidFieldType":67,"../Field":95,"FieldTypes":"FieldTypes","aphrodite/no-important":undefined,"object-assign":130,"react":undefined,"react-domify":131}],106:[function(require,module,exports){
'use strict';
...
},{"elemental":undefined,"react":undefined}],107:[function(require,module,exports){
'use strict';
...
},{"../../components/ItemsTableCell":89,"../../components/ItemsTableValue":90,"display-name":undefined,"react":undefined}],108:[function(require,module,exports){
'use strict';
...
},{"../../../admin/client/App/elemental":64,"../Field":95,"react":undefined}],109:[function(require,module,exports){
'use strict';

module.exports = require('../text/TextFilter');

},{"../text/TextFilter":127}],110:[function(require,module,exports){
'use strict';
...
var NumberColumn = _react2.default.createClass({
	...
	render: function render() {
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				_ItemsTableValue2.default,
				{ to: this.props.linkTo, field: this.props.col.type },
				this.renderValue()
			)
		);
	}
...
},{"../../components/ItemsTableCell":89,"../../components/ItemsTableValue":90,"numeral":undefined,"react":undefined}],111:[function(require,module,exports){
'use strict';
...
},{"../../../admin/client/App/elemental":64,"../Field":95,"react":undefined}],112:[function(require,module,exports){
'use strict';
...
},{"../../../admin/client/App/elemental":64,"react":undefined,"react-dom":undefined}],113:[function(require,module,exports){
'use strict';

module.exports = require('../../components/columns/ArrayColumn');

},{"../../components/columns/ArrayColumn":91}],114:[function(require,module,exports){
'use strict';
...
},{"../../mixins/ArrayField":94,"../Field":95}],115:[function(require,module,exports){
'use strict';
...
},{"../../../admin/client/App/elemental":64,"../Field":95,"react":undefined}],118:[function(require,module,exports){
'use strict';
...
module.exports = _Field2.default.create({
	...
	valueChanged: function valueChanged(value, fullObj) {
		var _this4 = this;
		...
		try {
			...
			if (window.__formRelSelectRefresh && window.__formRelSelectRefresh.length) {
				window.__formRelSelectRefresh.forEach(function (l) {
					return l(_this4.props._uid);
				});
			}
		} catch (c) {
			console.log(c);
	...
	onCreate: function onCreate(item) {
		...
		window.__formRelSelectRefresh.push(function (uid) {
			if (_this5.props._uid === uid) console.log('Same Call');else {}
		});
	...
	filterOption: function filterOption() {
		...
		if (this.props.filterKeys && this.props.filterKeys.length || this.props.addToLabel && this.props.addToLabel.length) {
			return function (option, value) {
				if (_this6.props.addToLabel && !option.newValue) {
					var label = option.name + " ",
					    labels = [].concat(_toConsumableArray(_this6.props.addToLabel));
				...
				var keys = ['name', 'id'];
				if (_this6.props.filterKeys) {
					keys = [].concat(_toConsumableArray(_this6.props.filterKeys), ['name', 'id']);
				}
	...
	renderSelect: function renderSelect(noedit) {
		return _react2.default.createElement(
			'div',
			null,
			_react2.default.createElement('input', { type: 'text', style: { position: 'absolute', width: 1, height: 1, zIndex: -1, opacity: 0 },
				tabIndex: '-1' }),
...
},{"../../../admin/client/App/elemental":64,"../../../admin/client/App/shared/CreateForm":66,"../../../admin/client/utils/lists":84,"../Field":95,"async":undefined,"lodash":undefined,"react":undefined,"react-select":undefined,"xhr":undefined}],121:[function(require,module,exports){
'use strict';
...
module.exports = _Field2.default.create({
	...
	renderField: function renderField() {
		...
		if (ops && ops.length >= 2 && ops[0].value === 'dynamic_fn') {
			...
			// TODO: This should be natively handled by the Select component
			options = numeric ? ops.map(function (i) {
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(_reactSelect2.default, {
				...
				options: options,
				onChange: this.valueChanged,
				multi: this.props.paths.multi
			})
		);
	}
});

},{"../../../admin/client/App/elemental":64,"../Field":95,"react":undefined,"react-select":undefined}],124:[function(require,module,exports){
'use strict';
...
var SelectFilter = function (_Component2) {
	...
	_createClass(SelectFilter, [{
		...
		value: function handleKeyDown(e) {
			if (_vkey2.default[e.keyCode] === '<control>' || _vkey2.default[e.keyCode] === '<command>' || _vkey2.default[e.keyCode] === '<meta>') {
...
},{"../Field":95}],127:[function(require,module,exports){
'use strict';
...
},{"../../fields/components/columns/IdColumn":92,"../../fields/components/columns/InvalidColumn":93,"../../fields/types/boolean/BooleanColumn":96,"../../fields/types/boolean/BooleanField":97,"../../fields/types/boolean/BooleanFilter":98,"../../fields/types/datetime/DatetimeColumn":101,"../../fields/types/datetime/DatetimeField":102,"../../fields/types/datetime/DatetimeFilter":103,"../../fields/types/list/ListColumn":104,"../../fields/types/list/ListField":105,"../../fields/types/list/ListFilter":106,"../../fields/types/name/NameColumn":107,"../../fields/types/name/NameField":108,"../../fields/types/name/NameFilter":109,"../../fields/types/number/NumberColumn":110,"../../fields/types/number/NumberField":111,"../../fields/types/number/NumberFilter":112,"../../fields/types/numberarray/NumberArrayColumn":113,"../../fields/types/numberarray/NumberArrayField":114,"../../fields/types/numberarray/NumberArrayFilter":115,"../../fields/types/password/PasswordColumn":116,"../../fields/types/password/PasswordField":117,"../../fields/types/password/PasswordFilter":118,"../../fields/types/relationship/RelationshipColumn":119,"../../fields/types/relationship/RelationshipField":120,"../../fields/types/relationship/RelationshipFilter":121,"../../fields/types/select/SelectColumn":122,"../../fields/types/select/SelectField":123,"../../fields/types/select/SelectFilter":124,"../../fields/types/text/TextColumn":125,"../../fields/types/text/TextField":126,"../../fields/types/text/TextFilter":127}]},{},[]);
